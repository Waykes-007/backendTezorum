...
// Envía un código de 6 dígitos al correo del usuario, con el mismo
// estilo de marca Waykes.
const enviarCodigoRecuperacion = async ({ correo, codigo }) => {
  try {
    await resend.emails.send({
      from:    'Waykes <noreply@waykes.com>',
      to:      correo,
      subject: `${codigo} es tu código para recuperar tu contraseña - Waykes`,
      html: `
        <div style="max-width:480px;margin:0 auto;font-family:Arial,sans-serif;">
          ...
          <div style="background:#fff;padding:32px 24px;border:1px solid #eee;border-top:none;border-radius:0 0 16px 16px;">
            <h2 style="color:#333;font-size:18px;margin:0 0 12px;">Recupera tu contraseña</h2>
            <p style="color:#666;font-size:14px;line-height:1.5;margin:0 0 24px;">
              Usa este código para restablecer tu contraseña. Vence en 10 minutos.
            </p>
            ...
            <p style="color:#999;font-size:12px;line-height:1.5;margin:0;">
              Si no solicitaste esto, ignora este correo. Tu contraseña seguirá igual.
            </p>
          </div>
        </div>`,
    });
